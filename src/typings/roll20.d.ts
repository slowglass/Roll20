...
interface Roll20ObjectBase<TImmutableSynchronousGetProperties, TImmutableAsynchronousGetProperties, TMutableSynchronousGetProperties, TMutableAsynchronousGetProperties> extends Roll20ObjectCore {
   ...
   */
  get<K extends keyof (TImmutableAsynchronousGetProperties & TMutableAsynchronousGetProperties)>(
    property: K,
    callback: (value: (TImmutableAsynchronousGetProperties & TMutableAsynchronousGetProperties)[K]) => void
  ): void;
   ...
   */
  set<K extends keyof (TMutableSynchronousGetProperties)>(property: K, value: (TMutableSynchronousGetProperties)[K]): void;
   ...
   * @param value The value to set for the specified property.
   */
  set<K extends keyof (TMutableAsynchronousGetProperties)>(property: K, value: (TMutableAsynchronousGetProperties)[K]): void;
   ...
   * @param value The value to set for the specified property.
   */
  setWithWorker<K extends keyof (TMutableSynchronousGetProperties | TMutableAsynchronousGetProperties)>(
    property: K,
    value: (TMutableSynchronousGetProperties | TMutableAsynchronousGetProperties)[K]
  ): void;
...
interface HandoutMutableAsynchronousGetProperties {
  notes: string;
  gmnotes: string;
}

interface Handout extends Roll20ObjectBase<HandoutImmutableSynchronousGetProperties, never, HandoutMutableSynchronousGetProperties, HandoutMutableAsynchronousGetProperties> {}
...
interface Character
  extends Roll20ObjectBase<
    CharacterImmutableSynchronousGetProperties,
    CharacterImmutableAsynchronousGetProperties,
    CharacterMutableSynchronousGetProperties,
    CharacterMutableAsynchronousGetProperties
  > {}
...
type HandoutCreationProperties = Partial<HandoutMutableSynchronousGetProperties & HandoutMutableSynchronousGetProperties>;
